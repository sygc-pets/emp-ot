...
### This branch is adapted for SYGC. 

It will be installed automatically as part of SYGC setup. The remaining readme is part of the original repo by emp-toolkit. 

Installation
=====

1. Install prerequisites using the instructions [here](https://github.com/emp-toolkit/emp-readme#detailed-installation). 
2. Optionally, if lattice-based OT is desired, install dependencies with `emp-ot/install_packages_lattice.sh`
3. Install [emp-tool](https://github.com/emp-toolkit/emp-tool).
4. To compile, run
```bash
    cmake .
    sudo make install
